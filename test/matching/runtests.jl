...
w[Edge(2,3)] = 2.
w[Edge(2,4)] = 11.
match = Matching.maximum_weight_maximal_matching(g,w)
...
w[Edge(2,5)] = -1
w[Edge(2,6)] = -1
match = Matching.maximum_weight_maximal_matching(g,w,0)
@test match.weight == 11.5
@test match.mate[1] == 4
@test match.mate[4] == 1
@test match.mate[2] == 3
...
match = Matching.minimum_weight_perfect_matching(g, w)
@test match.mate[1] == 4
@test match.mate[4] == 1
@test match.mate[2] == 3
@test match.mate[3] == 2
...
match = Matching.minimum_weight_perfect_matching(g, w, 50)
@test match.mate[1] == 4
@test match.mate[4] == 1
@test match.mate[2] == 3
@test match.mate[3] == 2
